...
import 'package:da_eat_da/MapView.dart';
...
class _ResultViewState extends State<ResultView> {
  UserData userData = UserData(
      latitude: (Get.arguments as SendLatLngtoResult).lat1,
      longitude: (Get.arguments as SendLatLngtoResult).lng1,
      radius: 500,
  ...
  Future<String> addRestaurantList(String keyword, {String myPageToken}) async {
    var result = await googlePlace.search.getNearBySearch(
        ...
        type: "restaurant",
        keyword: keyword,
        pagetoken: myPageToken != null ? myPageToken : null);
    if (result == null) {
      return null;
    }
  ...
  void randomPickRestaurant() async {
    ...
    if (pickedRestaurant.photos != null) {
      pickedRestaurantPhoto = await this
          .googlePlace
          .photos
          .get(pickedRestaurant.photos[0].photoReference, null, 400);
    } else {
  ...
  Widget restaurantDetailCard() {
    return Card(
      child: Container(
          ...
          child: (restaurantList.length == 0 || pickedRestaurant == null
                  ...
                  children: [
                    Container(
                        ...
                        child: ClipRRect(
                            ...
                            child: pickedRestaurantPhoto != null
                                ? Image.memory(
                                    pickedRestaurantPhoto,
                                    fit: BoxFit.fill,
                                  )
                                : Text("No Image"))),
      ...
      return Scaffold(
        ...
        child: Center(
          ...
          child: Column(
            ...
            children: [CircularProgressIndicator(), Text(waitMessage)],
          ),
        )),
      ));
    } else {
